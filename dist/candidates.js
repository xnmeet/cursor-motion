...
function scoreCandidate({ path: _path, measurement, descriptor, context }) {
    ...
    if (!measurement.staysInBounds)
        score += 45;
    return score;
}
export function makeCandidates({ start, end, bounds = null, startForward = { x: 1, y: 0 }, endForward = { x: 1, y: 0 }, params = {}, }) {
